...
$(document).ready(function () {
    ...
    url1 = "http://localhost:8985/ajax/firstmenu";
    url2 = "http://localhost:8985/ajax/secondmenu";
    url3 = "http://localhost:8985/ajax/thirdmenu";
    url4 = "http://localhost:8985/ajax/fourthmenu";
    url5 = "http://localhost:8985/ajax/fifthmenu";

    $('#val').on('click', function () {
        $.ajax({
            url: url1, async: false, success: function (result) {
    ...
    $('#val2').on('click', function () {
        $.ajax({
            url: url2, async: false, success: function (result) {
                $("#content").hide().html(result).fadeIn('slow');
            }
        });
    });
    ...
    $('#val3').on('click', function () {
        $.ajax({
            url: url3, async: false, success: function (result) {
                $("#content").hide().html(result).fadeIn('slow');
            }
        });
    });
    ...
    $('#val4').on('click', function () {
        $.ajax({
            url: url4, async: false, success: function (result) {
                $("#content").hide().html(result).fadeIn('slow');
            }
        });
    });
    ...
    $('#val5').on('click', function () {
        $.ajax({
            url: url5, async: false, success: function (result) {
                $("#content").hide().html(result).fadeIn('slow');
            }
        });
    });
